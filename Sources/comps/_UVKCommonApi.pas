...
{$ENDIF}
  ...
  begin
    ...
    begin
      // ResultString := vResp.ContentAsString(); // SDG
      // ResultString := ResultString.Trim([#$FEFF]); // SDG
      // result := ResultString; // SDG
      if (result = '') then // SDG
        result := vResp.ContentAsString(); // SDG
      result := result.Trim([#$FEFF]); // SDG
    end
    else
    begin
